...
def main(_):
  ...
  if test_accuracy*100>=90 :
		os.system('sshpass -p "yourpassword" scp /root/pythonservice/tf_files/retrained_graph.pb root@classify1.yourdomain.com:/root/classify/pythonrestservice/tf_files/retrained_graph.pb')
		os.system('sshpass -p "yourpassword" scp /root/pythonservice/tf_files/retrained_labels.txt root@classify1.yourdomain.com:/root/classify/pythonrestservice/tf_files/retrained_labels.txt')
		os.system('sshpass -p "yourpassword" scp -r /root/pythonservice/tf_files/inception root@classify1.yourdomain.com:/root/classify/pythonrestservice/tf_files/inception')
		os.system('sshpass -p "yourpassword" scp /root/pythonservice/tf_files/retrained_graph.pb root@classify2.yourdomain.com:/root/classify/pythonrestservice/tf_files/retrained_graph.pb')
        	os.system('sshpass -p "yourpassword" scp /root/pythonservice/tf_files/retrained_labels.txt root@classify2.yourdomain.com:/root/classify/pythonrestservice/tf_files/retrained_labels.txt')
        	os.system('sshpass -p "yourpassword" scp -r /root/pythonservice/tf_files/inception root@classify2.yourdomain.com:/root/classify/pythonrestservice/tf_files/inception')  
